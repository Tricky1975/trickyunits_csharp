#region Notice!
/* 
 * This work is not known, it was created by an author who released it under the terms of the MIT license.
 * I only made a few adaptions in order to make this work in the rest of my units, that's all.
 */ 
#endregion
...
namespace TrickyUnits
{
	...
	public static class Fmt
	{
		...
		{
			Console.Write( Fmt.sprintf( Format, Parameters ) );
		}
		#endregion
		#region fprintf
		public static void fprintf( TextWriter Destination, string Format, params object[] Parameters )
		{
			Destination.Write( Fmt.sprintf( Format, Parameters ) );
		}
		#endregion
		#region sprintf
