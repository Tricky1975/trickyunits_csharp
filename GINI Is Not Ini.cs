...
namespace TrickyUnits {
    ...
    class TGINI {
        ...
        /// <summary>
        /// Defines a string if the key is available, and won't do anything if it isn't.
        /// </summary>
        /// <param name="k"></param>
        /// <param name="v"></param>
        public void DefIfHave(string k, ref string v) {
            if (HasVar(k)) v = C(k);
        }
        ...
        static  GINI() {
            MKL.Version("Tricky Units for C# - GINI Is Not Ini.cs","19.07.09");
